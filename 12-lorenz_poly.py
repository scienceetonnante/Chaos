...
# initial state
#init_state_list = [[10, 10, 10],[-10,10,10],[10,-10,-10],[-10,-10,10]]
init_state_list = [[-5, 5, 5],[-5.001,5.001,5.001]] #,[10,10.001,10],[10,10,10.001]]
...
ani = animation.FuncAnimation(fig, animate, np.arange(0, NB_FRAMES), fargs=(res_list, lines), init_func = init,
                              interval=40, blit=False)
writer = animation.FFMpegWriter(fps=30, bitrate=5000)

ani.save('12-lorenz_poly.mp4', writer = writer, dpi=DPI)
plt.show()
